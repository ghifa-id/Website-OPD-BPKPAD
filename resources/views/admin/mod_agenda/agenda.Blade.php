        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white border-bottom py-3">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <a href="{{ route('tambah_agendaAdmin') }}" class="btn btn-success btn-sm px-3">
            ...
            <div class="card-body p-0">
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0" id="albumTable">
                        ...
                        <tbody>
                            @forelse ($agendaAdmin as $index => $row)
                                    ...
                                    <td colspan="6" class="text-center py-5">
                                        <div class="d-flex flex-column align-items-center">
                                            ...
                                            <p class="text-muted mb-3">Klik tombol "Tambah agenda" untuk membuat
                                                agenda baru</p>
                                            <a href="{{ route('tambah_agendaAdmin') }}" class="btn btn-success btn-sm">
