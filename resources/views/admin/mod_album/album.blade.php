        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white border-bottom py-3">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <a href="{{ route('tambah_album') }}" class="btn btn-success btn-sm px-3">
                                    ...
                                    <td class="text-center">
                                        @if ($row->url)
                                            <a href="{{ $row->url }}" target="_blank"
                                                class="btn btn-outline-success btn-sm rounded-pill" title="Lihat Album">
                                ...
                                <tr>
                                    <td colspan="8" class="text-center py-5">
                                        <div class="d-flex flex-column align-items-center">
                                            ...
                                            <a href="{{ route('tambah_album') }}" class="btn btn-success btn-sm">
    ...
    @push('scripts')
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const deleteTitle = document.getElementById('deleteAlbumTitle');
                ...
                deleteButtons.forEach(button => {
                    button.addEventListener('click', function() {
                        ...
                        deleteForm.action = "{{ url('/administrator/album') }}/" + id;
