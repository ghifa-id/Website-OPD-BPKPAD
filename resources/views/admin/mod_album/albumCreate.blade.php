    ...
    <div class="container-fluid px-4">
        <div class="card my-4 shadow-lg border-0">
                ...
                <div class="bg-gradient-success shadow-success border-radius-lg pt-4 pb-3">
                    <div class="d-flex align-items-center justify-content-between px-3">
                        <h6 class="text-white text-capitalize mb-0">
                            <i class="fas fa-images me-2"></i>Tambah Album Baru
                        </h6>
                    </div>
                </div>
            </div>
            <div class="card-body p-5">
                ...
                <form action="{{ route('tambah_album') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <div class="bg-light rounded-3 p-3 border-start border-success border-4">
                                ...
                                <p class="text-muted mb-0 small">Lengkapi informasi album kegiatan dengan detail yang akurat
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="tgl_kegiatan" class="form-label fw-bold text-dark mb-2">
                                    <i class="fas fa-calendar-alt text-success me-2"></i>Tanggal Kegiatan
                                    <span class="text-danger">*</span>
                                </label>
                                <input type="date" name="tgl_kegiatan" id="tgl_kegiatan"
                                    ...
                                    value="{{ old('tgl_kegiatan') }}" required>
                                @error('tgl_kegiatan')
                                    <div class="invalid-feedback">
                                        <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                    </div>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label for="tempat" class="form-label fw-bold text-dark mb-2">
                                    <i class="fas fa-map-marker-alt text-success me-2"></i>Tempat Kegiatan
                                    <span class="text-danger">*</span>
                                </label>
                                <input type="text" name="tempat" id="tempat"
                                    class="form-control form-control-lg @error('tempat') is-invalid @enderror"
                                    value="{{ old('tempat') }}" required placeholder="Masukkan Tempat Kegiatan">
                                @error('tempat')
                                    <div class="invalid-feedback">
                                        <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                    </div>
                        ...
                        <div class="col-lg-8">
                            <div class="form-group">
                                <label for="keterangan" class="form-label fw-bold text-dark mb-2">
                                    <i class="fas fa-align-left text-success me-2"></i>Keterangan
                                    <span class="text-danger">*</span>
                                </label>
                                <textarea name="keterangan" id="editor1" class="form-control @error('keterangan') is-invalid @enderror"
                                    rows="8" placeholder="Deskripsikan kegiatan secara detail, termasuk tujuan, peserta, dan highlight acara...">{{ old('keterangan') }}</textarea>
                                @error('keterangan')
                                    <div class="invalid-feedback">
                                        <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                    </div>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="gbr_album" class="form-label fw-bold text-dark mb-2">
                                    <i class="fas fa-image text-success me-2"></i>Cover Album
                                </label>
                        ...
                        <div class="col-12">
                            <div class="d-flex gap-3 pt-4 border-top">
                                <button type="submit" name="submit" class="btn btn-success btn-lg px-5 shadow-sm">
                                    <i class="fas fa-plus-circle me-2"></i>Tambahkan Album
                                </button>
                                <a href="{{ url()->previous() }}"
