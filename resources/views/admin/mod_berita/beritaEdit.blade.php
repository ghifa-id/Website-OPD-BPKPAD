        ...
        <div class="card my-4 shadow-lg border-0">
            ...
            <div class="card-body p-5">
                ...
                <form action="{{ route('update_listberita', ['id_berita' => $berita->id_berita]) }}" method="POST"
                    ...
                    {{-- Berita Utama --}}
                    <div class="form-group mb-4">
                        <label class="form-label fw-bold text-success mb-2 d-block">
                    ...
                    <div class="form-group mb-4">
                        <label class="form-label fw-bold text-success mb-2">
                            <i class="fas fa-align-left text-success me-2"></i>Isi Berita <span class="text-danger">*</span>
                        </label>
                        <textarea name="isi_berita" id="editor1" class="form-control form-control-lg" style="min-height: 200px;" required>{{ old('isi_berita', $berita->isi_berita) }}</textarea>
                    </div>
                    ...
                    <div class="form-group mb-4">
                        <label class="form-label fw-bold text-success mb-2">
                            <i
                                class="fas fa-image text-success me-2"></i>{{ $berita->gambar ? 'Ganti Gambar' : 'Upload Gambar' }}
                        </label>
                    ...
                    <div class="form-group mb-4">
                        <label class="form-label fw-bold text-success mb-2">
                            <i class="fas fa-tags text-success me-2"></i>Tag
                        </label>
