...
@section('title', 'Edit Dokumen Perencanaan dan Litbang')
    ...
    <div class="container-fluid px-4">
        <div class="card my-4 shadow-lg border-0">
                ...
                <div class="bg-gradient-success shadow-success border-radius-lg pt-4 pb-3">
                    <div class="d-flex align-items-center justify-content-between px-3">
                        <h6 class="text-white text-capitalize mb-0">
                            <i class="fas fa-file-alt me-2"></i>Edit Dokumen Perencanaan dan Litbang
                        </h6>
                    </div>
                </div>
            </div>
            <div class="card-body p-5">
                ...
                <form action="{{ route('update.dokperenlitbang', $dokumen->id_dokperenlitbang) }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf

                    <div class="alert alert-warning mb-4">
                        <strong><i class="fas fa-exclamation-triangle me-2"></i>Perhatian!</strong>
                        Silahkan Upload 1 File dengan ekstensi (*.pdf). Jika dokumen terbagi beberapa file, gabungkan dulu
                        ke satu file PDF.
                    </div>

                    <div class="mb-4">
                        <label for="jenis" class="form-label fw-bold text-dark">
                        ...
                        <select name="jenis" id="jenis"
                            ...
                            <option value="0" disabled>--Pilih Dokumen--</option>
                            @foreach ($jenisOptions as $key => $value)
                                <option value="{{ $key }}" {{ $dokumen->jenis == $key ? 'selected' : '' }}>
                                    {{ $value }}
                                </option>
                            @endforeach
                        </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="tahun_dokumen" id="tahun_dokumen"
                                    ...
                                    value="{{ old('tahun_dokumen', $dokumen->tahun_dokumen) }}" min="1900"
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-text mt-2">
                                    ...
                                    @if ($dokumen->cover_file)
                                        <div class="mt-3">
                                            <label class="fw-semibold">Cover Saat Ini:</label><br>
                                            <img src="{{ asset('asset/img_dokumen/' . $dokumen->cover_file) }}"
                                                alt="Cover Lama" style="max-width: 200px; border-radius: 8px;">
                                        </div>
                                    @endif
                                    <div id="coverPreview" class="mt-3" style="display: none;">
                                        <label class="fw-semibold">Preview Cover Baru:</label><br>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="file" name="nama_file" id="file"
                            class="form-control form-control-lg @error('file') is-invalid @enderror" accept=".pdf"
                        ...
                        <div class="form-text mt-2">
                            ...
                            @if ($dokumen->file)
                                ...
                                File saat ini:
                                <a href="{{ asset($dokumen->file) }}" target="_blank">{{ $dokumen->nama_file }}</a>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="pt-4 border-top d-flex gap-3">
                        ...
                        <a href="{{ route('dokperenlitbang') }}" class="btn btn-outline-secondary btn-lg px-4 shadow-sm">
