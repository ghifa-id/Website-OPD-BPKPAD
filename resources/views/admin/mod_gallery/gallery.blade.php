        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white border-bottom py-3">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <a href="{{ route('tambah_gallery') }}" class="btn btn-success btn-sm px-3">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="mb-3">Apakah Anda yakin ingin menghapus foto gallery berikut?</p>
    ...
    @push('scripts')
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const deleteTitle = document.getElementById('deleteGalleryTitle');
                ...
                deleteButtons.forEach(button => {
                    button.addEventListener('click', function() {
                        ...
                        deleteForm.action = "{{ url('administrator/gallery') }}/" + id;
