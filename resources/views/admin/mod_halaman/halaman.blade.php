...
@section('content')
    <div class="container-fluid px-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h3 mb-0 text-gray-800 fw-bold">Menu Konten</h1>
                <p class="text-muted mb-0">Kelola Menu Konten BPKPAD</p>
            </div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white border-bottom py-3">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <a href="{{ route('tambah_halamanbaru') }}" class="btn btn-success btn-sm px-3">
                    ...
                    <table class="table table-hover align-middle mb-0" id="albumTable" style="width: 100%">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th style="width: 100px;">Tanggal Posting</th>
                                <th class="text-center" style="width: 130px;">Aksi</th>
                            </tr>
                        </thead>
                        <tbody>
                            @forelse ($halaman as $index => $row)
                                @php
                                    $level = $row->parent ? $row->parent->halaman : 'Menu Utama';
                                @endphp
                                <tr>
                                    ...
                                    <td>
                                        <a target="_blank" href="{{ url('page/detail/' . $row->judul_seo) }}"
                                            style="color: blue; text-decoration: underline;">
                                            page/detail/{{ $row->judul_seo }}
                                        </a>
                                    </td>
                                    <td>{{ \Carbon\Carbon::parse($row->tgl_posting)->translatedFormat('d F Y') }}
                                    </td>
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-2">
                                            <a href="{{ route('edit_halamanbaru', $row->id_halaman) }}"
                                                class="btn btn-outline-success btn-sm px-2 py-1" title="Edit">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <button type="button" class="btn btn-outline-danger btn-sm btn-delete"
                                                data-id="{{ $row->id_halaman }}" data-title="{{ $row->judul }}"
                                                title="Hapus Menu">
                                ...
                                <tr>
                                    <td colspan="8" class="text-center py-4">
                                        <div class="d-flex flex-column align-items-center">
                                            ...
                                            <a href="{{ route('tambah_menuwebsite') }}" class="btn btn-success btn-sm mt-2">
