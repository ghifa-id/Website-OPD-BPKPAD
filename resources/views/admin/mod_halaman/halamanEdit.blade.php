    ...
    <div class="container-fluid px-4">
        <div class="card my-4 shadow-lg border-0">
                ...
                <div class="bg-gradient-success shadow-success border-radius-lg pt-4 pb-3">
                    <div class="d-flex align-items-center justify-content-between px-3">
                        <h6 class="text-white text-capitalize mb-0">
                            <i class="fas fa-edit me-2"></i>Edit Halaman Statis
                        </h6>
                    </div>
                </div>
            </div>
            <div class="card-body p-5">
                ...
                <form action="{{ route('update_halamanbaru', $halaman->id_halaman) }}" method="POST"
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <div class="bg-light rounded-3 p-3 border-start border-success border-4">
                                ...
                                <p class="text-muted mb-0 small">Perbarui informasi halaman statis dengan detail yang akurat
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-8">
                            <div class="form-group">
                                ...
                                <textarea name="isi_halaman" id="editor1"
                                    ...
                                    placeholder="Masukkan konten halaman">{{ old('isi_halaman', $halaman->isi_halaman) }}</textarea>
                                @error('isi_halaman')
                                    <div class="invalid-feedback">
                                        <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                    </div>
                        ...
                        <div class="col-lg-8">
                            <div class="form-group">
                                ...
                                <small class="text-muted mt-2 d-block">
                                    <i class="fas fa-info-circle me-1"></i>Maksimal ukuran gambar 3MB (jpg, jpeg, png)
                                </small>
                                @error('gambar')
                                    <div class="invalid-feedback">
                                        <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                ...
                                @if ($halaman->gambar)
                                    <div class="mt-3">
                                        ...
                                        <div class="border p-2 rounded-3 d-inline-block">
                                            <img src="{{ asset('asset/foto_statis/' . $halaman->gambar) }}"
                                                alt="Gambar Halaman" class="img-fluid rounded-2 shadow-sm"
                                                style="max-height: 200px;">
                                            <div class="mt-2 text-center">
                                                <a href="{{ asset('asset/foto_statis/' . $halaman->gambar) }}"
