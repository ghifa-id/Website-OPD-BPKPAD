                ...
                <div class="bg-gradient-success shadow-success border-radius-lg pt-4 pb-3">
                    <div class="d-flex align-items-center justify-content-between px-3">
                        <h6 class="text-white text-capitalize mb-0">
                            <i class="fas fa-globe me-2"></i>Identitas Website
                        </h6>
                    </div>
                </div>
            </div>
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        <div class="bg-light rounded-3 p-3 border-start border-success border-4">
                            ...
                            <p class="text-muted mb-0 small">Lengkapi identitas website dengan informasi yang akurat</p>
                        </div>
                    </div>
                </div>

                <form id="identitasForm" class="form-horizontal">
                    @csrf
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <div class="form-group">
                                <label for="nama_website" class="form-label fw-bold text-dark mb-2">
                                    <i class="fas fa-heading text-success me-2"></i>Nama Website
                                    <span class="text-danger">*</span>
                                </label>
                                <input type="text" name="nama_website" id="nama_website"
                                    class="form-control form-control-lg @error('nama_website') is-invalid @enderror"
                                    value="{{ old('nama_website', $identitas->nama_website ?? '') }}" required
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="email" name="email" id="email"
                                    ...
                                    value="{{ old('email', $identitas->email ?? '') }}" required
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <div class="form-group">
                                <label for="no_telp" class="form-label fw-bold text-dark mb-2">
                                    <i class="fas fa-phone text-success me-2"></i>No Telpon
                                    <span class="text-danger">*</span>
                                </label>
                                <input type="tel" name="no_telp" id="no_telp"
                                    class="form-control form-control-lg @error('no_telp') is-invalid @enderror"
                                    value="{{ old('no_telp', $identitas->no_telp ?? '') }}" required
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <div class="form-group">
                                <label for="facebook" class="form-label fw-bold text-dark mb-2">
                                    <i class="fas fa-share-alt text-success me-2"></i>Sosial Media
                                </label>
                                <input type="text" name="facebook" id="facebook"
                                    class="form-control form-control-lg @error('facebook') is-invalid @enderror"
                                    value="{{ old('facebook', $identitas->facebook ?? '') }}"
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label for="keterangan" class="form-label fw-bold text-dark mb-2">
                                    <i class="fas fa-info-circle text-success me-2"></i>Info Footer
                                    <span class="text-danger">*</span>
                                </label>
                                <textarea name="keterangan" id="keterangan" class="form-control @error('keterangan') is-invalid @enderror"
                                    rows="4" placeholder="Masukkan informasi footer...">{{ old('keterangan', $identitas->keterangan ?? '') }}</textarea>
                                @error('keterangan')
                                    <div class="invalid-feedback">
                                        <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="d-flex gap-3 pt-4 border-top">
                                <button type="submit" id="btnUpdate" class="btn btn-success btn-lg px-5 shadow-sm">
                                    <i class="fas fa-save me-2"></i>Simpan Perubahan
                                </button>
                                <a href="{{ url('/') }}" class="btn btn-outline-secondary btn-lg px-4 shadow-sm">
            ...
            $('#identitasForm').submit(function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            $('#alert-message').removeClass('alert-danger').addClass(
                                'alert-success').html(
