    ...
    <div class="container-fluid px-4">
        <div class="card my-4 shadow-lg border-0">
                ...
                <div class="bg-gradient-success shadow-success border-radius-lg pt-4 pb-3">
                    <div class="d-flex align-items-center justify-content-between px-3">
                        <h6 class="text-white text-capitalize mb-0">
                            <i class="fas fa-bullhorn me-2"></i>Tambah Jabatan Baru
                        </h6>
                    </div>
                </div>
            </div>
            <div class="card-body p-5">
                ...
                <form action="{{ route('tambah_jabatan') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <div class="bg-light rounded-3 p-3 border-start border-success border-4">
                                ...
                                <p class="text-muted mb-0 small">Lengkapi informasi Jabatan dengan detail yang akurat
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="tipe_jabatan" id="tipe_jabatan"
                                    ...
                                    value="{{ old('tipe_jabatan') }}" required placeholder="Masukkan tipe jabatan ">
                                @error('tipe_jabatan')
                                    <div class="invalid-feedback">
                                        <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                    </div>
