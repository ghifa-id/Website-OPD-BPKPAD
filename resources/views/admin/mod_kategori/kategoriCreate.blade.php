        ...
        <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                    <h6 class="text-white text-capitalize ps-3">Tambah Halaman Baru</h6>
                </div>
            </div>
            <div class="card-body">
                @if (session('success'))
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('store.kategoriberita') }}" method="POST">
                        @csrf
                        ...
                        <a href="{{ route('kategoriberita') }}" class="btn btn-secondary">Kembali</a>
                    </form>
                </div>
            </div>
        @endsection
