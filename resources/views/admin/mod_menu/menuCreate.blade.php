...
@section('title', 'Tambah Menu Website')
    ...
    <div class="container-fluid px-4">
        <div class="card my-4 shadow-lg border-0">
                ...
                <div class="bg-gradient-success shadow-success border-radius-lg pt-4 pb-3">
                    <div class="d-flex align-items-center justify-content-between px-3">
                        <h6 class="text-white text-capitalize mb-0">
                            <i class="fas fa-plus-circle me-2"></i>Tambah Menu Website
                        </h6>
                    </div>
                </div>
            </div>
            <div class="card-body p-5">
                ...
                <form action="{{ route('store_menuwebsite') }}" method="POST" class="form-horizontal">
                    @csrf
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <div class="bg-light rounded-3 p-3 border-start border-success border-4">
                                ...
                                <p class="text-muted mb-0 small">Lengkapi informasi menu website dengan detail yang akurat
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-8">
                            <div class="form-group">
                                ...
                                <input type="text" name="link_menu" id="link_menu"
                                    ...
                                    value="{{ old('link_menu') }}" required placeholder="Masukkan link menu">
                                @error('link_menu')
                        ...
                        <div class="col-lg-8">
                            <div class="form-group">
                                ...
                                <select name="level_menu" id="level_menu"
                                    ...
                                    <option value="0" {{ old('level_menu') == '0' ? 'selected' : '' }}>Menu Utama
                                    </option>
                                    @foreach ($menus as $menu)
                                        <option value="{{ $menu->id_menu }}"
                                            {{ old('level_menu') == $menu->id_menu ? 'selected' : '' }}>
                                            {{ $menu->nama_menu }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-lg-8">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_menu" id="nama_menu"
                                    ...
                                    value="{{ old('nama_menu') }}" required placeholder="Masukkan nama menu">
                                @error('nama_menu')
                                    <div class="invalid-feedback">
                                        <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                    </div>
                                ...
                                <div class="d-flex gap-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="position" id="positionTop"
                                            value="Top" {{ old('position') == 'Top' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="position" id="positionBottom"
                                            value="Bottom" {{ old('position') == 'Bottom' ? 'checked' : '' }}>
                        ...
                        <div class="col-lg-8">
                            <div class="form-group">
                                ...
                                <input type="number" name="urutan" id="urutan"
                                    ...
                                    value="{{ old('urutan') }}" required placeholder="Masukkan urutan menu"
                                    style="width: 100px;">
                                @error('urutan')
                                    <div class="invalid-feedback">
                                        <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
