    ...
    <div class="container-fluid px-4">
        <div class="card my-4 shadow-lg border-0">
                ...
                <div class="bg-gradient-success shadow-success border-radius-lg pt-4 pb-3">
                    <div class="d-flex align-items-center justify-content-between px-3">
                        <h6 class="text-white text-capitalize mb-0">
                            <i class="fas fa-trophy me-2"></i>Tambah Penghargaan Baru
                        </h6>
                    </div>
                </div>
            </div>
            <div class="card-body p-5">
                ...
                <form action="{{ route('store_penghargaan') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <div class="bg-light rounded-3 p-3 border-start border-success border-4">
                                ...
                                <p class="text-muted mb-0 small">Lengkapi informasi penghargaan dengan detail yang akurat
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="judul" id="judul"
                                    ...
                                    value="{{ old('judul') }}" required placeholder="Masukkan judul penghargaan">
                                @error('judul')
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="pemberi" id="pemberi"
                                    ...
                                    value="{{ old('pemberi') }}" required placeholder="Masukkan nama pemberi penghargaan">
                                @error('pemberi')
                                    <div class="invalid-feedback">
                                        <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                    </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="tahun" id="tahun"
                                    ...
                                    value="{{ old('tahun') }}" required min="1900" max="{{ date('Y') }}"
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea name="deskripsi" id="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" rows="8"
                                    placeholder="Deskripsikan penghargaan secara detail...">{{ old('deskripsi') }}</textarea>
                                @error('deskripsi')
                                    <div class="invalid-feedback">
                                        <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                    </div>
                        ...
                        <div class="col-12">
                            <div class="d-flex gap-3 pt-4 border-top">
                                <button type="submit" name="submit" class="btn btn-success btn-lg px-5 shadow-sm">
                                    <i class="fas fa-plus-circle me-2"></i>Tambahkan Penghargaan
                                </button>
                                <a href="{{ url()->previous() }}"
