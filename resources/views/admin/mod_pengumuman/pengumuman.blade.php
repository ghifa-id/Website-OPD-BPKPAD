        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white border-bottom py-3">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <a href="{{ route('tambah_pengumumanAdmin') }}" class="btn btn-success btn-sm px-3">
                                    ...
                                    <td>
                                        @if ($row->file_pendukung)
                                            <a href="{{ asset('asset/files/' . $row->file_pendukung) }}" target="_blank"
                                                class="text-success d-block text-truncate" style="max-width: 100px;">
                                    ...
                                    <td colspan="6" class="text-center py-5">
                                        <div class="d-flex flex-column align-items-center">
                                            ...
                                            <p class="text-muted mb-3">Klik tombol "Tambah pengumuman" untuk membuat
                                                pengumuman baru</p>
                                            <a href="{{ route('tambah_pengumumanAdmin') }}" class="btn btn-success btn-sm">
