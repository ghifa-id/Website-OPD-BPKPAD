...
@section('title', 'Tambah Konten PPID')
        ...
        <div class="card my-4 shadow-lg border-0">
            <div class="card-header bg-gradient-success text-white rounded-top">
                <h5 class="mb-0 text-white" style="color: white !important;">
                    <i class="fas fa-file-alt me-2 text-white"></i>Tambah Konten PPID
                </h5>
            ...
            <div class="card-body p-5 bg-light">
                ...
                <form action="{{ route('store.ppidKontenAdmin') }}" method="POST" enctype="multipart/form-data">
                    @csrf
            ...
            99 => 'Informasi Dikecualikan',
                    ...
                    <div class="mb-4">
                        <label for="file" class="form-label fw-bold">
                            <i class="fas fa-upload me-2 text-success"></i>File Dokumen (PDF) <span
