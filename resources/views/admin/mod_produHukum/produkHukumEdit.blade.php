    ...
    <div class="container-fluid px-4">
        <div class="card my-4 shadow-lg border-0">
                ...
                <div class="bg-gradient-success shadow-success border-radius-lg pt-4 pb-3">
                    <div class="d-flex align-items-center justify-content-between px-3">
                        <h6 class="text-white text-capitalize mb-0">
                            <i class="fas fa-edit me-2"></i>Edit Produk Hukum
                        </h6>
                    </div>
                </div>
            </div>
            <div class="card-body p-5">
                ...
                <form action="{{ route('update.produkHukum', $proHukum->id_produk_hukum) }}" method="POST"
                        ...
                        <div class="col-lg-8">
                            <div class="form-group">
                                ...
                                <input type="text" name="judul" id="judul"
                                    ...
                                    value="{{ old('judul', $proHukum->judul) }}" required>
                                @error('judul')
                    ...
                    <div class="row mb-4">
                        <div class="col-lg-8">
                            <div class="form-group">
                                <label for="ket" class="form-label fw-bold text-dark mb-2">
                                    <i class="fas fa-heading text-success me-2"></i>Keterangan
                                    <span class="text-danger">*</span>
                                </label>
                                <input type="text" name="ket" id="ket"
                                    class="form-control form-control-lg @error('ket') is-invalid @enderror"
                                    value="{{ old('ket', $proHukum->ket) }}" required>
                                @error('ket')
                                    <div class="invalid-feedback">
                                        <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                    </div>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="file" class="form-label fw-bold text-dark mb-2">
                                    <i class="fas fa-file-upload text-success me-2"></i>File Produk Hukum
                                </label>
                                <div class="upload-area border-2 border-dashed border-success rounded-3 p-4 text-center position-relative"
                                    ...
                                    <input type="file" name="file" id="file"
                                        ...
                                        accept=".pdf,.doc,.docx,.xls,.xlsx,.ppt,.pptx" style="cursor: pointer;">
                                    <div class="upload-content" id="uploadContent">
                                        @if ($proHukum->nama_file)
                                            <i class="fas fa-file-check text-success mb-2" style="font-size: 2rem;"></i>
                                            <p class="mb-1 fw-semibold">File saat ini:</p>
                                            <small class="text-muted">{{ $proHukum->nama_file }}</small>
                                        @else
                                            <i class="fas fa-cloud-upload-alt text-success mb-2"
                                                style="font-size: 2rem;"></i>
                                            <p class="mb-1 fw-semibold">Klik untuk upload file baru</p>
