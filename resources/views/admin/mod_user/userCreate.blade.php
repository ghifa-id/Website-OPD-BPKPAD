        ...
        <div class="card my-4 shadow-sm border-0">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-success shadow-success border-radius-lg pt-4 pb-3">
                    <h6 class="text-white text-capitalize ps-3 mb-0">Tambah User Baru</h6>
                </div>
            </div>
            <div class="card-body p-4">
                ...
                <form action="{{ route('store.manajemenuser') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <select name="level" id="level" class="form-select @error('level') is-invalid @enderror"
                                ...
                                <option value="kontributor" {{ old('level') == 'kontributor' ? 'selected' : '' }}>
                                    Kontributor</option>
                            </select>
                            @error('level')
                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="blokir" id="blokir" class="form-select @error('blokir') is-invalid @enderror"
                                ...
                                <option value="N" {{ old('blokir') == 'N' ? 'selected' : '' }}>Aktif</option>
                                <option value="Y" {{ old('blokir') == 'Y' ? 'selected' : '' }}>Blokir</option>
                            </select>
                            @error('blokir')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
