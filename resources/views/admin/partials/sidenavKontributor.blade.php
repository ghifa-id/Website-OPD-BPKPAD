<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2"
    ...
    <div class="sidenav-header">
        <a class="navbar-brand px-4 py-3 m-0" href="http://127.0.0.1:8000/" target="_blank">
            <img src="https://www.pesisirselatankab.go.id/assets/images/logo2.png" alt="Logo Pesisir Selatan"
                class="ms-1 text-sm text-success"></span>
        </a>

    </div>
    <hr class="horizontal success mt-0 mb-2">
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            {{-- Modul berita --}}
            <li class="nav-item">
                <a class="nav-link text-success" href="#navbar-berita" data-bs-toggle="collapse" role="button">
                ...
                <div class="collapse" id="navbar-berita">
                    <ul class="nav flex-column ms-3">
                        <li class="nav-item">
                            <a class="nav-link menu-link text-success" href="{{ route('listberita') }}">
            ...
            {{-- Modul Foto --}}
            <li class="nav-item">
                <a class="nav-link text-success" href="#navbar-foto" data-bs-toggle="collapse" role="button">
                ...
                <div class="collapse" id="navbar-foto">
                    <ul class="nav flex-column ms-3">
                        <li class="nav-item">
                            <a class="nav-link menu-link text-success" href="{{ route('album') }}">
                                <i class="material-symbols-rounded opacity-5">image</i>
                                <span class="nav-link-text ms-1">Sampul/Cover Album</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link text-success" href="{{ route('gallery') }}">
            ...
            {{-- Modul Video --}}
            <li class="nav-item">
                <a class="nav-link text-success" href="#navbar-video" data-bs-toggle="collapse" role="button">
                ...
                <div class="collapse" id="navbar-video">
                    <ul class="nav flex-column ms-3">
                        <li class="nav-item">
                            <a class="nav-link menu-link text-success" href="{{ route('playlist') }}">
                                <i class="material-symbols-rounded opacity-5">image</i>
                                <span class="nav-link-text ms-1">Sampul/Cover Video</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link text-success" href="{{ route('video') }}">
                                <i class="material-symbols-rounded opacity-5">folder</i>
            ...
            {{-- Modul Web --}}
            <li class="nav-item">
                <a class="nav-link text-success" href="#navbar-web" data-bs-toggle="collapse" role="button">
                ...
                <div class="collapse" id="navbar-web">
                    <ul class="nav flex-column ms-3">
                        <!-- Pengumuman -->
                        <li class="nav-item">
                            <a class="nav-link menu-link text-success" href="{{ route('admin.pengumuman') }}">
                        ...
                        <!-- File Download -->
                        <li class="nav-item">
                            <a class="nav-link menu-link text-success" href="{{ route('download') }}">
                        ...
                        <!-- List Agenda -->
                        <li class="nav-item">
                            <a class="nav-link menu-link text-success" href="{{ route('administrator.agenda') }}">
            ...
            <li class="nav-item mt-4 pt-2">
                <div class="position-relative">
                    <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bold text-success opacity-8 mb-3">
                        <i class="fas fa-user-cog me-2"></i>Account Pages
                    </h6>
                    <div class="border-bottom border-success border-opacity-25 ms-4"></div>
                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link text-success" href="{{ route('edit.profil') }}">
            ...
            <li class="nav-item">
                <form method="POST" action="{{ route('logout') }}" class="m-0 p-0">
                    @csrf
                    <button type="submit" class="nav-link text-success bg-transparent border-0 w-100 text-start">
