...
@section('content')
    <div class="container-fluid px-4 py-4">
        <!-- Header Section -->
        <div class="mb-4">
            <h1 class="h2 fw-bold text-dark mb-2">Dashboard</h1>
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <h3 class="fw-bold text-dark mb-0">{{ $jumlahHalaman }}</h3>
                                <div class="mt-2">
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <h3 class="fw-bold text-dark mb-0">{{ $jumlahAgenda }}</h3>
                                <div class="mt-2">
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <h3 class="fw-bold text-dark mb-0">{{ $jumlahUser }}</h3>
                                <div class="mt-2">
        ...
        <div class="row g-4">
            ...
            <div class="col-xl-8 col-lg-8">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-header bg-white border-0 py-3">
                        <div class="d-flex align-items-center justify-content-between">
                            <h5 class="fw-bold text-dark mb-0">Grafik Kunjungan</h5>
                            <div class="btn-group btn-group-sm" role="group">
                                <button type="button" class="btn btn-primary active">7 Hari</button>
            ...
            <div class="col-xl-4 col-lg-4">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-header bg-white border-0 py-3">
                        <h6 class="fw-bold text-dark mb-0">Grafik Kepuasan Publik</h6>
                    </div>
                    <div class="card-body">
                ...
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="collapse show" id="quickWriteForm">
                        ...
                        <form action="{{ route('administrator.beritaCepat') }}" method="POST" class="p-4"
                            ...
                            <!-- Isi Berita -->
                            <div class="mb-4">
                                <label class="form-label fw-semibold text-dark">Isi Berita</label>
                                <textarea name="isi_berita" rows="6" class="form-control form-control-modern"
