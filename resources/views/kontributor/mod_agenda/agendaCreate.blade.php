    ...
    <div class="container-fluid px-4">
        <div class="card my-4 shadow-lg border-0">
            ...
            <div class="card-body p-5">
                ...
                <form action="{{ route('kontributor_store.agenda') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                                ...
                                <div id="uploadArea" class="border-2 border-dashed rounded-3 p-4 mb-3 upload-area">
                                    ...
                                    <div id="imagePreview" class="d-none text-center">
                                        ...
                                        <div class="preview-controls">
                                            <button type="button" id="changeFile" class="btn btn-sm btn-outline-primary">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="tanggal" id="rangepicker"
                                    ...
                                    value="{{ old('tanggal') }}" required placeholder="Pilih rentang tanggal">
                                @error('tanggal')
                                    <div class="invalid-feedback">
                                        <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                    </div>
...
@push('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Ganti kode daterangepicker dengan ini:
