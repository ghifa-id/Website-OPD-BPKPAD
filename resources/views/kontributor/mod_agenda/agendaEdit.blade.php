    ...
    <div class="container-fluid px-4">
        <div class="card my-4 shadow-lg border-0">
                ...
                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                    <div class="d-flex align-items-center justify-content-between px-3">
                        <h6 class="text-white text-capitalize mb-0">
                            <i class="fas fa-calendar-alt me-2"></i>Edit Agenda
                        </h6>
                    </div>
                </div>
            </div>
            <div class="card-body p-5">
                ...
                <form action="{{ route('update.agendaAdmin', $agenda->id_agenda) }}" method="POST"
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <div class="bg-light rounded-3 p-3 border-start border-primary border-4">
                                ...
                                <p class="text-muted mb-0 small">Perbarui informasi agenda dengan detail yang akurat</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label for="tema" class="form-label fw-bold text-dark mb-2">
                                    <i class="fas fa-heading text-primary me-2"></i>Tema Agenda
                                    <span class="text-danger">*</span>
                                </label>
                                <input type="text" name="tema" id="tema"
                                    class="form-control form-control-lg @error('tema') is-invalid @enderror"
                                    value="{{ old('tema', $agenda->tema) }}" required placeholder="Masukkan tema agenda">
                                @error('tema')
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label for="isi" class="form-label fw-bold text-dark mb-2">
                                    <i class="fas fa-align-left text-primary me-2"></i>Isi Agenda
                                    <span class="text-danger">*</span>
                                </label>
                                <textarea name="isi" id="editor1" class="form-control @error('isi') is-invalid @enderror" rows="8"
                                    placeholder="Deskripsikan agenda secara detail...">{{ old('isi', $agenda->isi_agenda) }}</textarea>
                                @error('isi')
                                    <div class="invalid-feedback">
                                        <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                    </div>
                                ...
                                <div id="uploadArea" class="border-2 border-dashed rounded-3 p-4 mb-3 upload-area">
                                    @if ($agenda->gambar)
                                        <div id="imagePreview" class="text-center">
                                            <img id="previewImage" src="{{ asset('storage/' . $agenda->gambar) }}"
                                                alt="Preview" class="img-fluid mb-3" style="max-height: 150px;">
                                            <div class="mb-3">
                                                <i class="fas fa-file-image fa-3x text-primary d-none" id="fileIcon"></i>
                                            </div>
                                            <p class="file-name fw-bold mb-2">Gambar saat ini</p>
                                        ...
                                        <div id="uploadContent" class="text-center d-none">
                                    ...
                                    @else
                                        ...
                                        <div id="imagePreview" class="d-none text-center">
                                            <img id="previewImage" src="#" alt="Preview"
                                                class="img-fluid mb-3 d-none" style="max-height: 150px;">
                                            <div class="mb-3">
                                                <i class="fas fa-file-image fa-3x text-primary d-none" id="fileIcon"></i>
                                            </div>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label for="tempat" class="form-label fw-bold text-dark mb-2">
                                    <i class="fas fa-map-marker-alt text-primary me-2"></i>Tempat
                                    <span class="text-danger">*</span>
                                </label>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="jam" class="form-label fw-bold text-dark mb-2">
                                    <i class="fas fa-clock text-primary me-2"></i>Jam Mulai - Selesai
                                    <span class="text-danger">*</span>
                                </label>
                                <input type="text" name="jam" id="jam"
                                    class="form-control form-control-lg @error('jam') is-invalid @enderror"
                                    value="{{ old('jam', $agenda->jam) }}" required placeholder="Contoh: 08:00 - 17:00">
                                @error('jam')
                                    <div class="invalid-feedback">
                                        <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                    </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="tanggal" class="form-label fw-bold text-dark mb-2">
                                    <i class="fas fa-calendar-day text-primary me-2"></i>Tanggal Mulai - Selesai
                                    <span class="text-danger">*</span>
                                </label>
...
@push('styles')
    <style>
        /* Gunakan style yang sama dengan agendaCreate.blade.php */
        .card {
            border-radius: 20px;
            overflow: hidden;
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            uploadArea.addEventListener('click', function() {
                if (!filePreview.classList.contains('d-none') && !uploadContent.classList.contains(
                        'd-none')) return;
                fileInput.click();
            });
            ...
            $('#rangepicker').daterangepicker({
                ...
                startDate: moment('{{ $agenda->tgl_mulai }}', 'YYYY-MM-DD'),
                endDate: moment('{{ $agenda->tgl_selesai }}', 'YYYY-MM-DD')
            });

            // Handler untuk update tampilan tanggal
