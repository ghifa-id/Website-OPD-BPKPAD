...
@section('content')
    <div class="container-fluid px-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h3 mb-0 text-gray-800 fw-bold">Download</h1>
                <p class="text-muted mb-0">Kelola Download BPKPAD</p>
            </div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white border-bottom py-3">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <a href="{{ route('kontributor_tambah_download') }}" class="btn btn-primary btn-sm px-3">
                                ...
                                <tr class="album-row" data-status="{{ $row->aktif }}"
                                    ...
                                    {{-- <td class="text-center">
                                        <div class="d-flex justify-content-center gap-2">
                                            <a href="{{ route('edit_downloadAdmin', $row->id_download) }}"
                                            ...
                                            <button type="button" class="btn btn-sm btn-outline-danger px-2 btn-delete"
                                                title="Hapus" data-id="{{ $row->id_download }}">
                                                <i class="fas fa-trash-alt"></i>
                                            </button>

                                            <!-- Form tersembunyi untuk delete -->
                                            <form id="delete-form-{{ $row->id_download }}"
                                                action="{{ route('delete_downloadAdmin', $row->id_download) }}"
                                    ...
                                    <td colspan="6" class="text-center py-5">
                                        <div class="d-flex flex-column align-items-center">
                                            ...
                                            <p class="text-muted mb-3">Klik tombol "Tambah download" untuk membuat
                                                download baru</p>
                                            <a href="{{ route('tambah_download') }}" class="btn btn-primary btn-sm">
