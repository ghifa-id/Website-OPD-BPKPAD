    ...
    <div class="container-fluid px-4">
        <div class="card my-4 shadow-lg border-0">
                ...
                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                    <div class="d-flex align-items-center justify-content-between px-3">
                        <h6 class="text-white text-capitalize mb-0">
                            <i class="fas fa-edit me-2"></i>Edit File Download
                        </h6>
                    </div>
                </div>
            </div>
            <div class="card-body p-5">
                ...
                <form action="{{ route('update.downloadAdmin', $download->id_download) }}" method="POST"
                        ...
                        <div class="col-lg-8">
                            <div class="form-group">
                                ...
                                <input type="text" name="judul" id="judul"
                                    ...
                                    value="{{ old('judul', $download->judul) }}" required>
                                @error('judul')
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="file" class="form-label fw-bold text-dark mb-2">
                                    <i class="fas fa-file-upload text-primary me-2"></i>File Download
                                </label>

                                @if ($download->nama_file)
                                    <div class="mb-3">
                                        <p class="mb-1">File saat ini:</p>
                                        <a href="{{ asset('asset/files/' . $download->nama_file) }}" target="_blank"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function resetUploadContent() {
                uploadContent.innerHTML =
                    '<i class="fas fa-cloud-upload-alt text-primary mb-2" style="font-size: 2rem;"></i><p class="mb-1 fw-semibold">Klik untuk upload file</p><small class="text-muted">atau drag & drop file di sini</small>';
