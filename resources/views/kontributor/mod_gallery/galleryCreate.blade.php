    ...
    <div class="container-fluid px-4">
        <div class="card my-4 shadow-lg border-0">
            ...
            <div class="card-body p-5">
                ...
                @endif
                <form action="{{ route('kontributor_store.gallery') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <button type="button" class="btn btn-sm btn-outline-primary" onclick="addUploadGroup()">+ Tambah
                            Foto</button>
                    </div>
