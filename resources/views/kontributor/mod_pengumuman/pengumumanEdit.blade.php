    ...
    <div class="container-fluid px-4">
        <div class="card my-4 shadow-lg border-0">
            ...
            <div class="card-body p-5">
                ...
                <form action="{{ route('update.pengumumanAdmin', $pengumuman->id_announcement) }}" method="POST"
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <div class="bg-light rounded-3 p-3 border-start border-primary border-4">
                                ...
                                <p class="text-muted mb-0 small">Perbarui informasi pengumuman dengan detail yang akurat
                                </p>
                            </div>
                        </div>
                    </div>

                    <!-- Row 1: Judul & Tanggal Posting -->
                    <div class="row mb-4">
                        <div class="col-lg-8">
                            <div class="form-group">
                                <label for="judul" class="form-label fw-bold text-dark mb-2">
                                    <i class="fas fa-heading text-primary me-2"></i>Judul Pengumuman
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="tanggal_posting" class="form-label fw-bold text-dark mb-2">
                                    <i class="fas fa-calendar-alt text-primary me-2"></i>Tanggal Posting
                                    <span class="text-danger">*</span>
                                </label>
                                <input type="date" name="tanggal_posting" id="tanggal_posting"
                                    ...
                                    value="{{ old('tanggal_posting', $pengumuman->tanggal_posting) }}" required>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label for="perihal" class="form-label fw-bold text-dark mb-2">
                                    <i class="fas fa-tag text-primary me-2"></i>Perihal
                                    <span class="text-danger">*</span>
                                </label>
                                <input type="text" name="perihal" id="perihal"
                                    class="form-control form-control-lg @error('perihal') is-invalid @enderror"
                                    value="{{ old('perihal', $pengumuman->perihal) }}" required
                                    placeholder="Masukkan perihal pengumuman">
                                @error('perihal')
                                    <div class="invalid-feedback">
                                        <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                    </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-lg-8">
                            <div class="form-group">
                                ...
                                <textarea name="deskripsi_pengumuman" id="deskripsi_pengumuman"
                                    class="form-control @error('deskripsi_pengumuman') is-invalid @enderror" rows="8"
                                    placeholder="Deskripsikan pengumuman secara detail...">{{ old('deskripsi_pengumuman', $pengumuman->deskripsi_pengumuman) }}</textarea>
                        ...
                        <div class="col-lg-8">
                            <div class="form-group">
                                <label for="file_pendukung" class="form-label fw-bold text-dark mb-2">
                                    <i class="fas fa-file-upload text-primary me-2"></i>Lampiran File
                                </label>
                                <div id="uploadArea" class="border-2 border-dashed rounded-3 p-4 mb-3 upload-area">
                                    <div id="uploadContent"
                                        class="text-center {{ $pengumuman->file_pendukung ? 'd-none' : '' }}">
                                    ...
                                    <div id="imagePreview"
                                        ...
                                        <p class="file-name fw-bold mb-2">
                                            @if ($pengumuman->file_pendukung)
                                                {{ $pengumuman->file_pendukung }}
                                            @endif
                                        </p>
                                ...
                                @if ($pengumuman->file_pendukung)
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" name="hapus_file"
                                            id="hapus_file">
                        ...
                        <div class="col-lg-8">
                            <div class="form-group">
                                <label for="keterangan" class="form-label fw-bold text-dark mb-2">
                                    <i class="fas fa-sticky-note text-primary me-2"></i>Keterangan Tambahan
                                </label>
                                <textarea name="keterangan" id="keterangan" class="form-control @error('keterangan') is-invalid @enderror"
                                    rows="4" placeholder="Tambahkan catatan atau informasi tambahan jika diperlukan...">{{ old('keterangan', $pengumuman->keterangan) }}</textarea>
                                @error('keterangan')
                                    <div class="invalid-feedback">
                                        <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                    </div>
...
@push('styles')
    <style>
        /* Keep the same styles as the create form */
        .card {
            border-radius: 20px;
            overflow: hidden;
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function handleFileSelect(file) {
                if (file) {
                    ...
                    // Uncheck delete checkbox if user uploads new file
                    if (hapusFileCheckbox) {
                        hapusFileCheckbox.checked = false;
                    }
                }
            }
            ...
            removeBtn.addEventListener('click', function(e) {
                ...
                // Check delete checkbox if exists
                if (hapusFileCheckbox) {
                    hapusFileCheckbox.checked = true;
                }
            });
